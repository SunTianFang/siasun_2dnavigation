...
public:
	// 视口端变量
    int      m_uWidth;               // 实际视口的宽度
    int      m_uHeight;              // 实际视口的高度
...
public:
    CScreenReference(int uWidth, int uHeight, float fRatio, const CPnt& ptCenter);
	CScreenReference();
	...
	// 设置视口的大小
    void SetViewPort(int uWidth, int uHeight);
