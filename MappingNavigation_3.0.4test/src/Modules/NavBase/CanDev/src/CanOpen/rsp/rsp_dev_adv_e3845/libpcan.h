...
//
// $Id: libpcan.h 368 2006-03-26 16:58:36Z khitschler $
//
//****************************************************************************
...
//QianYizhou Modify
//修正特定的波特率值，使能够与CAN分析仪正确通信，并去除无法正常通信的波特率
#if 0
...
#else                
#define CAN_BAUD_1M       0x001C        //   1 MBit/s
#define CAN_BAUD_500K     0x011C        // 500 kBit/s
#define CAN_BAUD_250K     0x031C        // 250 kBit/s
#define CAN_BAUD_100K     0x472F        // 100 kBit/s
#define CAN_BAUD_20K      0x672F        //  20 kBit/s
#endif
//Modify Ended 2014-4-2
