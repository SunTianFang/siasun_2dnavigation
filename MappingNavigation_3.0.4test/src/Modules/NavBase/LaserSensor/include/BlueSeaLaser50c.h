...
//
//   The interface of class "cLDS_50LaserScanner".
//
//   Author: yuminghao
//   Date:   2024. 01. 2418
//

#ifndef BLUESSEALASER50C_H
#define BLUESSEALASER50C_H
...
class cLDS_50LaserScanner : public CRangeScanner
{
public:
        cLDS_50LaserScanner(int fAngRes, float fStartAng, float fEndAng,CLaserScannerParam *cParam);
	~cLDS_50LaserScanner();
