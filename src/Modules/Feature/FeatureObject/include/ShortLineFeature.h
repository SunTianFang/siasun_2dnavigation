...
#define SHORT_LINE_MAX_DIST_CHANGE 400    // 最大允许距离变化量
...
///////////////////////////////////////////////////////////////////////////////
//   短直线特征(视为一种点特征)。
class DllExport CShortLineFeature : public CPointFeature
{
  protected:
  ...
  public:
    ...
    // 设置短直线特征的参数
    virtual void SetParam(float fWidth, float fAngle, int nWhichSideToUse, float fMaxIncidenceAngle,
                          int nMinNumPoints, float fMaxLength);
