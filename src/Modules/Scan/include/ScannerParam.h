...
class CScannerGroupParam : public vector<CLaserScannerParam>
{
  public:
    ...
    CScannerGroupParam& operator = (const CScannerGroupParam& Obj)
    {
        this->clear();
