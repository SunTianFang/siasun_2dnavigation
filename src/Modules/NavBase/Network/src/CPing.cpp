...
void CPing::SupportRoutine()
{
    ...
    {
#ifdef USE_BLACK_BOX
        if(FUNCUSED(USE_NVRAM_BLACKBOX))
        {}
        else
        {
            char*  ch;
            ...
            CustomBox.NewRecord();
            CustomBox <<"Ping Laser Failed"<<ch;
            CustomBox.EndRecord();
        }
#endif
    }
