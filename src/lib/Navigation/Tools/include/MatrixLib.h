...
void MatrixFree(struct CGenericMatrix *m);
/* Frees matrix structure and data space. */

void MatrixZero(struct CGenericMatrix *m);
...
int MatrixMult(const struct CGenericMatrix *A, const struct CGenericMatrix *B, 
    struct CGenericMatrix *C);
/*
